/*
    webapp.h -- HTTP Web Server header
 */
 ...
 */
  ...
  #define CONFIG_COM_CGI 0
#endif

#ifndef CONFIG_COM_EJSCRIPT
    #define CONFIG_COM_EJSCRIPT 0
#endif
#ifndef CONFIG_COM_ESP
    #define CONFIG_COM_ESP 0
#endif
#ifndef CONFIG_COM_FAST
    #define CONFIG_COM_FAST 0
#endif
#ifndef CONFIG_COM_MDB
    #define CONFIG_COM_MDB 0
#endif
#ifndef CONFIG_COM_PHP
    #define CONFIG_COM_PHP 0
#endif
#ifndef CONFIG_COM_PROXY
    #define CONFIG_COM_PROXY 0
#endif
#ifndef CONFIG_COM_SDB
    #define CONFIG_COM_SDB 0
#endif
#ifndef CONFIG_COM_SSL
    #define CONFIG_COM_SSL 0
#endif
#ifndef CONFIG_COM_TEST
    #define CONFIG_COM_TEST 0
#endif
...
/**
    Webapp configuration file directive parsing callback function
...
/**
    ...
    @description This will configure a web server based on either a configuration file or using the supplied
        IP address and port.
    @param configFile File name of the Webapp configuration file (appweb.conf) that defines the web server configuration.
...
/**
    Parse an Webapp configuration file
...
/**
    ...
    @description Create a simple web server without using a configuration file. The server is created to listen on
        the specified IP address and port. This routine provides a one-line embedding of Webapp. If you want to
...
/**
    ...
    @description Create a web server configuration based on the supplied config file. This routine provides
        a one-line embedding of Webapp. If you don't want to use a config file, try the #maRunSimpleWebServer
        instead.
    @param configFile File name of the Webapp configuration file (appweb.conf) that defines the web server configuration.
    @return Zero if successful, otherwise a negative Mpr error code. See the Webapp log for diagnostics.
    @ingroup MaState
