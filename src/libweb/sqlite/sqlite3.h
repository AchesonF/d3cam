/*
    sqlite3.h -- SQLite header. Modified for webapp Products
 */
...
#if CONFIG_COM_SQLITE || ME_SQLITE_PRODUCT
#ifndef _h_SQLITE3_
...
#define PACKAGE_VERSION_SQLITE     VERSION
