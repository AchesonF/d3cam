...
setting in libpcre.h (which is included below); it defines only PCRE_EXP_DECL,
...
internals, can #include libpcre.h first to get an application's-eye view.
...
used for the external interface and appears in libpcre.h, which is why its name
