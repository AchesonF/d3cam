/*
    libmpr.h -- Header for the Multithreaded Portable Runtime (MPR).
 */
...
struct  MprXml;
    ...
    #define CONFIG_MPR_LOGGING 1            /**< Default for logging is "on" */
#endif
...
/**
    ...
    @description Send a message to the MPR error logging subsystem.
        ...
        \n\n
        Logging typically is enabled in both debug and release builds and may be controlled via the build define CONFIG_MPR_LOGGING which is typically set via the MakeMe setting "logging: true".
        \n\n
...
#if CONFIG_COMPILER_HAS_DYN_LOAD || DOXYGEN
/**
...
/**
    ...
    @param flags Flags to modify the behavior of the event. Valid values are: MPR_EVENT_CONTINUOUS to create an event
        ...
        \n\n
        If using Webapp or the Http library, it is preferable to use the httpCreateEvent API when invoking callbacks on
            HttpStreams.
 ...
 */
    ...
    #define CONFIG_MPR_SSL_LOG_LEVEL 7
#endif
...
typedef struct Mpr {
     ...
     */
    void            *webappService;         /**< Webapp service object */
...
/**
    ...
    the application is using a watchdog/angel process to automatically restart the application (such as appman by webapp).
