...
#define ESP_COMPILE_SYMBOLS     0           /**< Override to compile in debug mode. Defaults to same as Webapp */
...
/**
    ...
    @param routeName Name of the route in the webapp.conf file for this ESP application or page
    @return Zero if successful, otherwise a negative MPR error code.
    @ingroup Esp
    @stability Evolving
  */
...
/**
    ...
    @description A route may have a default database configured via the EspDb webapp.conf configuration directive.
