...
PUBLIC void httpCreateCGIParams(HttpStream *stream)
{
    ...
    /*
        ...
        NOTE: Webapp refers to pathInfo as the app relative URI and scriptName as the app address before the pathInfo.
        In CGI|PHP terms, the scriptName is the webapp rx->pathInfo and the PATH_INFO is the extraPath.
     */
