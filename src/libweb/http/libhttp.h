/*
    libhttp.h -- Header for the Http Library.
...
/********************************** Tunables **********************************/
    ...
    #define CONFIG_HTTP_BASIC           0
#endif
#ifndef CONFIG_HTTP_CACHE
    #define CONFIG_HTTP_CACHE           0
#endif
#ifndef CONFIG_HTTP_DEFENSE
    #define CONFIG_HTTP_DEFENSE         0
#endif
#ifndef CONFIG_HTTP_DIGEST
    #define CONFIG_HTTP_DIGEST          0
#endif
#ifndef CONFIG_HTTP_DIR
    #define CONFIG_HTTP_DIR             0
#endif
#ifndef CONFIG_HTTP_PAM
    #define CONFIG_HTTP_PAM             0
#endif
#ifndef CONFIG_HTTP_HTTP2
    #define CONFIG_HTTP_HTTP2           0
#endif
#ifndef CONFIG_HTTP_UPLOAD
    #define CONFIG_HTTP_UPLOAD          0
#endif
#ifndef CONFIG_HTTP_WEB_SOCKETS
    #define CONFIG_HTTP_WEB_SOCKETS     0
#endif
...
#define HTTP_UNLIMITED MAXINT64
    ...
    #define ME_HTTP_SOFTWARE        "http-ser"     /**< Default Http protocol name used in Http Server header */
#endif
...
/**
    ...
    @param trace Tracing object
    @param name Formatter name. Set to "common" for the Common Log format or "detail" for the Webapp detailed trace format.
    @ingroup HttpTrace
    @stability Evolving.
    @internal
 */
...
/**
    ...
    @return Zero if successful, otherwise a negative Mpr error code. See the Webapp log for diagnostics.
    @ingroup HttpTrace
    @stability Evolving
*/
...
#if CONFIG_HTTP_WEB_SOCKETS || DOXYGEN
...
#if DEPRECATED || 1
    /*
        This will be removed in Webapp 10
     */
...
/**
    ...
    After calling, the normal Webapp request and inactivity timeouts will not apply to the returned socket object.
...
/**
    ...
    @description The HttpStream object represents a logical request stream to a peer.
        ...
        managed reference. Read Webapp memory allocation at doc/ref/memory.html.
        \n\n
...
#define HTTP_ROUTE_HOSTED               0x10000     /**< Route being hosted (webapp) */
...
typedef struct HttpRoute {
    ...
    Http            *http;                  /**< Http service object (copy of webapp->http) */
    ...
    void            *context;               /**< Hosting context (Webapp == EjsPool) */
...
/**
    ...
    @description This makes a filename by expanding the tokens "${token}" and then normalizing the path. Relative paths
        ...
        <ul>
            ...
            <li>BIN_DIR - for the shared library directory. E.g. /usr/local/lib/webapp/bin </li>
...
/**
    ...
    @param streamSeqno HttpStream->seqno identifier extracted when running in an MPR (Webapp) thread.
